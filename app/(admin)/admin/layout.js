...
//         {/* sidebar */}
//         <aside
//           className={`absolute left-0 top-0 h-full w-64 bg-white shadow-xl p-6 flex flex-col transform transition-transform ${
...
//     <h1 className="font-semibold text-base md:text-lg text-slate-600 truncate">
//       Admin Dashboard
//     </h1>
